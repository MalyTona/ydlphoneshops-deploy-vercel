...
import { CreateCategoryItemData } from '@/types/categories';
...
export default function CategoriesDataTable() {
    ...
    const { data, setData, post, processing, errors, reset } = useForm<Required<CreateCategoryItemData>>({
        name: '',
        slug: '',
        color: '',
        image: null,
                                ...
                                <form action="" onSubmit={submit} className="space-y-4">
                                    ...
                                    <div className="grid gap-6 py-4">
                                        <div className="grid gap-6 md:grid-cols-2">
                                            ...
                                            <div className="space-y-2">
                                                <Label htmlFor="category">Category Tailwind Color Class</Label>
